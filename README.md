...
## macOS_tryout Branch Note

The checkpoint (trained parameters) file is too large to be uploaded to GitHub. The latest checkpoint file can be found through this Google Drive [link](https://drive.google.com/file/d/1wJk3gaDKuNuSpy2ycX9QUCy_8sG3JOBM/view?usp=share_link).
